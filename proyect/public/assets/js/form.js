...
$("#formRegistro")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: `${ PROJECT_URL }/sistema/register/store`,
                datatype: "json",
                data: datos,
...
$("#formmateria")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: `${ PROJECT_URL }/sistema/materia`,
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if (respuesta.estado == true) {
                        ...
                        window.setTimeout(function () {
                            location.assign(`${ PROJECT_URL }/sistema/materia`);
                        }, 3500);
...
$("#formprofesor")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: `${ PROJECT_URL }/sistema/profesor`,
                datatype: "json",
                data: datos,
                success: function (data) {
                    console.log(data);
                    ...
                    if (data.estado == true) {
                        ...
                        window.setTimeout(function () {
                            location.assign(`${ PROJECT_URL }/sistema/profesor`);
                        }, 3500);
                    } else if (data.estado == false) {
                        Swal.fire({
                            position: "center",
...
$("#formDatos")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: `${ PROJECT_URL }/sistema/perfil/datos`,
                type: "post",
                dataType: "html",
                data: formData,
                cache: false,
...
$("#formPassword")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: `${ PROJECT_URL }/sistema/perfil/password`, //${ PROJECT_URL }/sistema/perfil/horario/agregar
                datatype: "json",
                data: datos,
                success: function (data) {
                    console.log(data);
...
$("#formHorario")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: `${ PROJECT_URL }/sistema/perfil/horario`,
                datatype: "json",
                data: datos,
                success: function (data) {
                    console.log(data);
...
$("#formConfirmarPassword")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: `${ PROJECT_URL }/sistema/cambio/password`,
                type: "post",
                dataType: "html",
                data: formdata,
                cache: false,
...
$("#formEnviarMailPassword")
    ...
    .validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: `${ PROJECT_URL }/sistema/forgot-password`,
                type: "post",
                dataType: "html",
                data: formdata,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if (respuesta.estado == true) {
                        ...
                        window.setTimeout(function () {
                            location.assign(`${ PROJECT_URL }/sistema/login`);
                        }, 3500);
                    } else if (respuesta.estado == false) {
                        Swal.fire({
                            position: "center",
