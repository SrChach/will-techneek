                    ...
                    <table class="main" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr
                            ...
                            <td class=""
                                ...
                                <span
                                    style="margin-top: 10px;display: block; font-weight:bold; color:#81D742;">Nuevo pedido creado</span>
                            </td>
                        </tr>
                        <tr
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            Hola <strong
                                                ...
                                                {{ $user->apellidos }} </strong> has creado un nuevo pedido.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            ...
                                            <table style="margin-left: auto; margin-right: auto;">
                                                <tr>
                                                    <th style="color:#3d3d3d; background-color: #e9e9e9; padding:.5em;">Folio de pedido</th>
                                                    <td style="padding: .5em;"> {{ $infoPedido->folio }}</td>
                                                </tr>

                                                <tr>
                                                    <th style="color:#3d3d3d; background-color: #e9e9e9; padding:.5em;">Materia</th>
                                                    <td style="padding: .5em;">{{ $infoPedido->materia }}</td>
                                                </tr>
                                                <tr>
                                                    <th style="color:#3d3d3d; background-color: #e9e9e9; padding:.5em;">Horas</th>
                                                    <td style="padding: .5em;">{{ $infoPedido->horas }}</td>
                                                </tr>
                                                <tr>
                                                    <th style="color:#3d3d3d; background-color: #e9e9e9; padding:.5em;">Monto total</th>
                                                    <td style="padding: .5em;">${{ $infoPedido->total }} </td>
                                                </tr>
                                            </table>
                        ...
                        <!-- falta link de pedido-->
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Concluye tu pago para agendar las clases.
                                        </td>
                                    </tr>
                                </table>
                            </td>
