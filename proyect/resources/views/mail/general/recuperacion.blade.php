                    ...
                    <table class="main" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr
                            ...
                            <td class=""
                                ...
                                <span style="margin-top: 10px;display: block; font-weight:bold; color:#81D742;">Recuperación de contraseña</span>
                            </td>
                        </tr>
                        <tr
                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            <strong style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                {{ $user->nombre }}
                                                {{ $user->apellidos }} 
                                            </strong> se ha generado un link de recuperación de contraseña. Accede a él para reestablecer tu contraseña.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
